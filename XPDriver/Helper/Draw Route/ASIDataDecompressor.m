...
+ (BOOL)uncompressDataFromFile:(NSString *)sourcePath toFile:(NSString *)destinationPath error:(NSError **)err
{
	...
	NSError *theError = nil;
	///Users/us14/Desktop/clint's project/fiveStarLuxuryCars Main/FiveStarLuxury_client/FiveStarLuxury_client/ASIDataDecompressor.m:161:34: Comparison of constant 'NSStreamEventErrorOccurred' (8) with expression of type 'NSStreamStatus' (aka 'enum NSStreamStatus') is always false
