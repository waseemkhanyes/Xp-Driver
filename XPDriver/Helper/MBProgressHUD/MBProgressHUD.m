...
static const CGFloat kDetailsLabelFontSize = 0.f;
...
- (void)setupLabels {
	...
	label.text = [self.labelText capitalizedString];
...
//CGSize detailsLabelSize = [detailsLabel.text sizeWithFont :detailsLabel.font constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    detailsLabel.lineBreakMode = detailsLabel.lineBreakMode;
...
- (void)updateUIForKeypath:(NSString *)keyPath {
	if ([keyPath isEqualToString:@"mode"] || [keyPath isEqualToString:@"customView"]) {
		...
		detailsLabel.text = [self.detailsLabelText capitalizedString];
